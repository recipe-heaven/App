...
class ChangePassPage extends StatefulWidget {
  ...
  final _user = User(id: 11, email: "skdaj", name: "navn test", username: "usernav", settings: null);
...
class ChangePassPageState extends State<ChangePassPage> {
  ...
  void _handleChangePass() async {
    ...
    if (formState.validate()) {
      ...
      var res = await widget._userService
          .changePass(newPass: widget._formData.newPass,oldPass: widget._formData.oldPass);
      if (res){
        ...
        child: Stack(
          children: [
            Padding(
              ...
              child: Text(widget._user.name, style: Theme.of(context).textTheme.headline1,),
            ),
            Column(
              children: [
                SizedBox(height: 40,),
                SizedBox(height: 70,),
                Text("Change Password", style: Theme.of(context).textTheme.headline1,),
                SizedBox(height: 10,),
                Form(
                    key: _formKey,
